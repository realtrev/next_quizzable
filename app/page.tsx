          ...
          <section className="relative">
            ...
            <div className="glass z-30 w-full">
              <nav id="navbar" className="body h-28">
                <Link
                  href="#"
                  className="wordmark blurry-shadow-sm shadow-primary"
                >
                  Quizzable
                </Link>
                <ul>
            ...
            >
              <div className="z-10 mx-auto w-2/3 text-center lg:mx-0 lg:w-3/5 lg:text-left">
                <h1>
                  <span className="text-primary">Studying</span> just got a
                  whole lot easier
                </h1>
              ...
              <div className="absolute -right-10 z-0">
                <div className="hero-card absolute" data-card="1"></div>
                <div className="hero-card absolute" data-card="2"></div>
                <div className="hero-card absolute" data-card="3">
          ...
          <section className="rounded-y-3xl relative z-20 overflow-hidden border-background-4 bg-gradient-to-t from-background-1 to-background-3 py-40">
            ...
            <div id="features" className="body grid grid-cols-3 gap-5">
              ...
              <div className="feature-card blurry-shadow h-[20rem] bg-gradient-to-tl from-primary to-teal py-12 shadow-primary">
                ...
                <p className="h-[3rem]">
                  Over 10 customizable study modes designed to cater to
          ...
          >
            <div className="body mx-auto grid grid-cols-3 gap-5">
              <div className="col-span-1">
                ...
                <h2>Our Community</h2>
                <p>
                  Take a look at some of the most popular study sets on
                  Quizzable, made by our community of users.
                </p>
              </div>
              {[
                {
                ...
                >
                  <div className="h-36">
                    ...
                    <p className="h-[3rem] text-paragraph">
                  ...
                  <div>
                    <p>
                      ...
                      <button
                        ...
                        onClick={(event) => {
                          router.push(`/users/${studySet.author}`);
                        }}
